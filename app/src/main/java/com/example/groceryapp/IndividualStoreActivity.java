...
/*
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Owner> owners = localDatabase.access().owners;
        String owner_name = "";

        for (Owner owner : owners) {
            if (owner.display_name == store_name) {
                owner_name = owner.display_name;
                break;
            }
        }
        ArrayList<String> products = getInformation.getInstance().getAllProducts(owner);
